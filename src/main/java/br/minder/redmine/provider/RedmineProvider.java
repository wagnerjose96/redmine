...
public class RedmineProvider {
	...
	private final static String TIME_ENTRIES = SERVER_PORT + PROJECT + "/time_entries?utf8=✓&f[]=spent_on&op[spent_on]=*&f[]=&available_columns[]=issue&c[]=issue.cf_3&c[]=spent_on&c[]=user&c[]=activity&c[]=hours";
